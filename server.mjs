...
const emptyLibraryConfig = () => ({ folders:[], rules:[], moves:[], hiddenFolders:[], hiddenPaths:[], pathTransforms:[], overrides:{} });
...
function sanitizeLibraryConfig(value) {
  ...
  return { folders, rules, moves, hiddenFolders, hiddenPaths, pathTransforms, overrides };
}
