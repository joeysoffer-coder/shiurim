...
async function loadManagedConfig(){
  try{
    ...
    if(response.ok){managedConfig=await response.json();managedAssignmentCache.clear();managedGroupsCache={episodes:null,config:null,value:null};render()}
  }catch{}
}
