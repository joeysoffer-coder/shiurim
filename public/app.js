...
const helpSteps=[
  {target:'.library-heading',title:'Your Shiurim Library',text:'Today’s Classes, folders, subfolders, and individual shiurim all appear here. New classes also appear in their regular folders, and opening a folder always starts you at the top.'},
  ...
  {target:'#sortSelect',title:'Sort and Find Favorites',text:'Choose newest, oldest, title, or numeric-aware audio filename order. Select Favorites only here to see every class you have saved.'},
  ...
  {target:'.topbar',title:'App Tools',text:'Contact Rabbi Joey, install or share the app, refresh the podcast feed, or reopen this Help tour from the buttons at the top.'}
];
...
$('.guided-blocker').addEventListener('click',()=>closeHelp(false));
