const CACHE='rabbi-joey-soffer-shiurim-v33';
const AUDIO_CACHE='js-torah-downloads-v1';
const SHELL=['/','/index.html','/styles.css?v=33','/app.js?v=33','/vendor/hls.mjs?v=1.6.16','/manifest.webmanifest?v=31','/icon.svg?v=31'];
