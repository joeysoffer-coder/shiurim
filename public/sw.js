const CACHE='rabbi-joey-soffer-shiurim-v36';
const AUDIO_CACHE='js-torah-downloads-v1';
const SHELL=['/','/index.html','/styles.css?v=36','/app.js?v=36','/vendor/hls.mjs?v=1.6.16','/manifest.webmanifest?v=36','/icon-rjs-v36-180.png','/icon-rjs-v36-192.png','/icon-rjs-v36-512.png'];
