...
let token=sessionStorage.getItem('rjsAdminToken')||'',config={theme:'classic',showTodaysClasses:true,folders:[],rules:[],moves:[],hiddenFolders:[],hiddenPaths:[],pathTransforms:[],disabledBuiltInRules:[],builtInRuleEdits:{},overrides:{}},episodes=[],selected=null,dirty=false;
...
$('showTodaysClasses').onchange=event=>{config.showTodaysClasses=event.target.checked;renderHomeSettings();changed()};
